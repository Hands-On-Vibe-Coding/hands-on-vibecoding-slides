...
- 슬로건: <span class="accent">"Your own personal AI assistant. Any OS. Any Platform."</span>

> 한 사람이 5개월 만에 만든 프레임워크가 <span class="accent">바이브 코딩 운동의 중심축</span>이 되었다.
...
| 지표 | 규모 *(2026.04 기준)* |
|------|---------------------|
| GitHub 별 | <span class="accent">347,000+</span> — 역사상 최다 신기록 |
| Forks | 74,800+ |
| 컨트리뷰터 | 900+ |
...
- <span class="accent">"AI/vibe-coded PRs welcome!"</span> — 바이브 코딩을 공식 환영하는 첫 메이저 OSS
